		...
		public void actionPerformed(ActionEvent e) 
			{
				...
				if(data.getUsers().contains(new User("", "", "", 0, null, userNameField.getText(), "", "", Long.parseLong("7894561235"), null)))
				{
					String pw = "";
					...
					if(data.getUsers().get(data.getUsers().indexOf(new User("", "", "", 0, null, userNameField.getText(), "", "", Long.parseLong("7894561235"), null))).checkPassword(pw))
					{
