...
public class DataStore 
{
	...
	OrderedListArray<User> data;
	Path path = Paths.get("Database");
	public DataStore()
	{
		//data = new TreeMap<String, User>();
		data = new OrderedListArray<User>();
	}
	...
	public OrderedListArray<User> getUsers()
	{
		return data;
	}
	...
	public void save()
	{
		...
		BufferedWriter writer = null;
			...
			{
				try {
					//writer.write(data.get().values()+"\n");
					writer.write(data.get(i).values()+"\n");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
